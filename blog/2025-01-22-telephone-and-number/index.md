...
PRI 学名“基群接口结构 (Primary Rate Interface Structure)”，又叫做“一次群接口”。对于欧洲和中国，采用 2048kbits 的传输速率时，基群接口的信道结构为 30B+D，B 信道的速率为 64kbit/s，用来传送用户信息，D 信道的传送速率为 64kbit/s，用来传送用户一网络信令。
